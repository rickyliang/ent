...
RouteBoxer.prototype.box = function (path, range) {
  ...
  if (path instanceof Array) {
    ...
    console.log("path instanceof google.maps.Polyline");
    if (path.getPath) {
  ...
  console.log("found intersecting cells");
  ...
  console.log("merged intersecting cells");
...
RouteBoxer.prototype.buildGrid_ = function (vertices, range) {
  ...
  var routeBounds = new LatLngBounds();
  for (var i = 0; i < vertices.length; i++) {
  ...
  console.log("NORTHEAST.lng = " + routeBounds.getNorthEast().lng().toString());
  console.log("Point 1 lng = " + routeBoundsCenter.rhumbDestinationPoint(90, range).lng().toString());
  ...
  for (i = 2; this.lngGrid_[i - 2] < routeBounds.getNorthEast().lng(); i++) {
    console.log("EAST " + i.toString() + " lng = " + routeBoundsCenter.rhumbDestinationPoint(90, range * i).lng().toString());
    this.lngGrid_.push(routeBoundsCenter.rhumbDestinationPoint(90, range * i).lng());
  }
  
  // Add lines from the center out to the west
  console.log("SOUTHWEST.lng = " + routeBounds.getSouthWest().lng().toString());
  for (i = 1; this.lngGrid_[1] > routeBounds.getSouthWest().lng(); i++) {
    console.log("WEST " + i.toString() + " lng = " + routeBoundsCenter.rhumbDestinationPoint(270, range * i).lng().toString());
    this.lngGrid_.unshift(routeBoundsCenter.rhumbDestinationPoint(270, range * i).lng());
  }
  
  // Create a two dimensional array representing this grid
  console.log(this.lngGrid_.length);
...
RouteBoxer.prototype.findIntersectingCells_ = function (vertices) {
  ...
  for (var i = 1; i < vertices.length; i++) {
    ...
    if (gridXY[0] === hintXY[0] && gridXY[1] === hintXY[1]) {
      ...
      // console.log("markCell_");
      this.markCell_(gridXY);
      // console.log("markCell_ DONE");
...
RouteBoxer.prototype.markCell_ = function (cell) {
  ...
  var y = cell[1];
  // console.log([x, y]);
  // console.log(this.grid_.length, this.grid_[0].length);
