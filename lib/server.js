...
var yelpClient = Yelp.createClient({
    ...
    token: '8VaCxE-ust33Y5x4TgfW4Q32Jd2Sf_sg',
    token_secret: '0GWldhU3YxYS11Vcp5_df3IOtjA'
});
...
function getDistanceMatrixRequestOptions(origins, destinations) {
    ...
    var options = {
        ...
        path: '/maps/api/distancematrix/json?key=' + API_KEY + '&origins=' + origins + '&destinations=' + destinations
    }
    return options;
}
